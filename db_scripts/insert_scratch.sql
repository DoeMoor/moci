INSERT INTO mini_pcie_modules_type ("name")
VALUES ('4G/GPS SIMCOM 7600-G')
;-- RETURNING *;
...
INSERT INTO display_adapters ("name",manufacturer_qr_code)
VALUES 
('av123z7m','GE00000626856'),
...
-- INSERT INTO controller_connector_types ("name")
-- VALUES ('rg45'),
-- 	('rj49'),
-- 	('rgay50')
-- ;-- RETURNING *;
-- -- DELETE FROM controller_connector_types ;


INSERT INTO controller_types
("name",io_module_slot_amount)
VALUES ('moduline 4','8'),('moduline mini','4');
...
INSERT INTO controller_pcb_hw_versions (version_number,revision,amount_of_connectors)
VALUES
  ('306',(SELECT revision FROM controller_pcb_hw_versions_rev LIMIT 1 ),'5'),
  ('306',NULL,'5'),
  ('307',NULL,'3')
;-- RETURNING *;
DELETE FROM controller_pcb_hw_versions ;

-- alter TABLE controllers_pinout
-- RENAME column controller_type to controller_type_id;



INSERT INTO controllers_pinout  
	(
	controller_type_id,
	controller_pcb_hw_versions_number,
	controller_pcb_hw_versions_revision,
	slot_pinout_json
	)
VALUES 
(
	(select id FROM controller_types LIMIT 1),
	(select version_number FROM controller_pcb_hw_versions LIMIT 1),
	'a',
'{
  ...
  "connector_E": {
	...
	(select version_number FROM controller_pcb_hw_versions LIMIT 1 OFFSET 1),
	'',
'{
...
;-- RETURNING *;
DELETE FROM controllers_pinout ;
...
VALUES 
(
	(select id FROM io_module_types LIMIT 1),
	'GE00000623365',
	'GE00000623033',
	'rma_number',
...
(
	...
	'GE00000423027',
	'rma_number',
	(select id FROM io_module_hw_versions LIMIT 1 OFFSET 1)
)
;-- RETURNING*;
...
VALUES 
((select id FROM controllers limit 1),(select id FROM io_modules LIMIT 1),'1'),
...
VALUES
((select id FROM customers limit 1),(select id FROM projects LIMIT 1))
;-- RETURNING *;
