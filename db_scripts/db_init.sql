...
(
    ...
    "pcb_version_number"             INT GENERATED BY DEFAULT AS IDENTITY UNIQUE,
...
CREATE TABLE "display_adapters_type"
(
...
ALTER TABLE "display_adapters"
    ADD FOREIGN KEY ("display_adapters_type_name") REFERENCES "display_adapters_type" ("name");

ALTER TABLE "mini_pcie_modules"
    ADD FOREIGN KEY ("mini_pcie_modules_type_id") REFERENCES "mini_pcie_modules_type" ("id");

ALTER TABLE "enclosure"
    ADD FOREIGN KEY ("controller_id") REFERENCES "controllers" ("id");
