...
CREATE TABLE "controller_pcb_hw_versions_rev" ("revision" varchar(2) UNIQUE PRIMARY KEY);
...
ADD FOREIGN KEY ("controller_types_id") REFERENCES "controller_types" ("id");

ALTER TABLE "controllers"
ADD FOREIGN KEY ("projects_id") REFERENCES "projects" ("id");

ALTER TABLE "controllers"
ADD FOREIGN KEY ("controllers_pcb_hw_versions_id") REFERENCES "controller_pcb_hw_versions" ("id");

ALTER TABLE "controllers"
ADD FOREIGN KEY ("manufacturers_id") REFERENCES "manufacturers" ("id");

ALTER TABLE "controllers"
ADD FOREIGN KEY ("mini_pcie_modules_id") REFERENCES "mini_pcie_modules" ("id");

ALTER TABLE "controllers"
ADD FOREIGN KEY ("m2_modules_types_id") REFERENCES "m2_modules_types" ("id");

ALTER TABLE "controllers"
ADD FOREIGN KEY ("display_adapters_id") REFERENCES "display_adapters" ("id");

ALTER TABLE "controllers"
ADD FOREIGN KEY ("can_termination_confs_id") REFERENCES "can_termination_confs" ("id");

ALTER TABLE "controllers"
ADD FOREIGN KEY ("order_id") REFERENCES "orders" ("id");

ALTER TABLE "controller_notes"
ADD FOREIGN KEY ("controllers_id") REFERENCES "controllers" ("id");

ALTER TABLE "led_daughter_board"
ADD FOREIGN KEY ("controllers_id") REFERENCES "controllers" ("id");

ALTER TABLE "controller_slot"
ADD FOREIGN KEY ("controllers_id") REFERENCES "controllers" ("id");

ALTER TABLE "controller_slot"
ADD FOREIGN KEY ("io_modules_id") REFERENCES "io_modules" ("id");

ALTER TABLE "controller_pcb_hw_versions"
ADD FOREIGN KEY ("revision") REFERENCES "controller_pcb_hw_versions_rev" ("revision");

ALTER TABLE "controller_confs"
ADD FOREIGN KEY ("mini_pcie_modules_type_id") REFERENCES "mini_pcie_modules_type" ("id");

ALTER TABLE "controller_confs"
ADD FOREIGN KEY ("m2_modules_types_id") REFERENCES "m2_modules_types" ("id");

ALTER TABLE "controller_confs"
ADD FOREIGN KEY ("can_termination_conf_id") REFERENCES "can_termination_confs" ("id");

ALTER TABLE "controller_confs"
ADD FOREIGN KEY ("controller_types_id") REFERENCES "controller_types" ("id");

ALTER TABLE "controller_conf_io_module_type_junction"
ADD FOREIGN KEY ("controller_confs") REFERENCES "controller_confs" ("id");

ALTER TABLE "controller_conf_io_module_type_junction"
ADD FOREIGN KEY ("io_module_types") REFERENCES "io_module_types" ("id");

ALTER TABLE "io_modules"
ADD FOREIGN KEY ("io_module_types_id") REFERENCES "io_module_types" ("id");

ALTER TABLE "io_modules"
ADD FOREIGN KEY ("io_module_hw_versions_id") REFERENCES "io_module_hw_versions" ("id");

ALTER TABLE "io_modules"
ADD FOREIGN KEY ("order_id") REFERENCES "orders" ("id");

ALTER TABLE "io_module_notes"
ADD FOREIGN KEY ("io_modules_id") REFERENCES "io_modules" ("id");

ALTER TABLE "customer_notes"
ADD FOREIGN KEY ("customers_id") REFERENCES "customers" ("id");

ALTER TABLE "customer_projects_junction"
ADD FOREIGN KEY ("customers_id") REFERENCES "customers" ("id");
