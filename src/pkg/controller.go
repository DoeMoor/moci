...
type NewIoModule struct {
	Id                       uuid.UUID `json:"id"`
	IoModuleTypeID           uuid.UUID `json:"ioModuleTypeId"`
	ManufacturerTopQrCode    string    `json:"manufacturerTopQrCode"`
	ManufacturerBottomQrCode string    `json:"manufacturerBottomQrCode"`
	RMANumber                *string    `json:"rmaNumber"`
	IoModuleHwVersion        *string    `json:"ioModuleHwVersion"`
	IoModuleHwVersionsID     uuid.UUID `json:"ioModuleHwVersionsId"`
	OrderID                  uuid.UUID `json:"orderId"`
...
type NewControllerJsonFromFrontend struct {
	...
	LedBoardID                uuid.UUID     `json:"ledBoardId"`
	LedBoardQrCode            string        `json:"ledBoardQrCode"`
	IoModules                 []NewIoModule `json:"ioModules"`
}
