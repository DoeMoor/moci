...
func (cnf *ApiCfg) GetAllMiniPCeModulesType(c *fiber.Ctx) error {
...
func (cnf *ApiCfg) GetMiniPCeModuleById(c *fiber.Ctx) error {
	return nil
}

func (cnf *ApiCfg) GetAllMiniPCeModules(c *fiber.Ctx) error {
	return nil
}

func (cnf *ApiCfg) CreateMiniPCeModule(c *fiber.Ctx) error {
	return nil
}
